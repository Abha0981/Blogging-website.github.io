        ...
        <div className="singlepost">
            <div className="singlepostwrapper">
                ...
                <h1 className="posttitle">Use of robotocis nowdays
                    <div className="divsinglepostedit">
